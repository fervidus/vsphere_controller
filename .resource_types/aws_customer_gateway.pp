# This file was automatically generated on 2019-11-24 21:41:44 -0500.
...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # 
    # Values can match `/^-?\d+$/`.
    Puppet::Resource::Param(Pattern[/^-?\d+$/], 'bgp_asn'),

    # (a Optional[String])
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'customer_gateway_id'),

    # (a Optional[String])
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'customer_gateway_ids'),
    ...
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'ip_address'),

    # (a Optional[String])
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'public_ip'),

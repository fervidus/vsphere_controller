...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'group_name'),

    # (a Optional[String])
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'group_names'),

    # (a Optional[Integer])
    # 
    # Values can match `/^-?\d+$/`.
    Puppet::Resource::Param(Pattern[/^-?\d+$/], 'partition_count'),

    # (a Optional[String])
    # 
    # Values can match `//`.
    Puppet::Resource::Param(Pattern[//], 'strategy')
  ],
  [
    # (a String)
    # 
